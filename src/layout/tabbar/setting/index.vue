<template>
  <el-button size="small" icon="Refresh" circle type="success" @click="updateRefresh"></el-button>
  <el-button size="small" icon="FullScreen" circle type="warning" @click="fullScreen"></el-button>
